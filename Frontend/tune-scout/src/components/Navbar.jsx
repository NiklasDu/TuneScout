  ...
  return (
    <nav className="bg-white border-gray-200 dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div
          className="flex items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse"
        ...
        >
                  ...
                  <g id="c">
                    <g id="e">
                      <g id="b">
                        ...
                        />
                        <use xlink:to="#Link" y="420" />
                        <use xlink:to="#Link" y="840" />
                        <use xlink:to="#Link" y="1260" />
                      </g>
                      <use xlink:to="#Link" y="1680" />
                    </g>
          ...
          <div
            ref={dropdownRef}
            className={`z-50 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow-sm dark:bg-gray-700 transition-all duration-150 ${
